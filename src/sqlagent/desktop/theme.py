...
DARK_QSS = """
QMainWindow, QWidget { background: #0D0D0D; color: #A9B7C6; font-family: "JetBrains Mono","Consolas","Microsoft YaHei"; font-size: 13px; }
...
QLineEdit, QPlainTextEdit, QTextEdit {
    background: #1A1A1A; color: #A9B7C6; border: 1px solid rgba(255,255,255,0.06);
...
QComboBox QAbstractItemView {
    background: #1A1A1A; color: #A9B7C6; selection-background-color: #8B3A3A;
    border: 1px solid rgba(255,255,255,0.06); outline: none;
}
QPushButton {
    background: #1F1F1F; color: #A9B7C6; border: 1px solid rgba(255,255,255,0.06);
...
QPushButton:disabled { background: #1A1A1A; color: #5A6270; }
QTableWidget {
    background: #1A1A1A; color: #A9B7C6; gridline-color: rgba(255,255,255,0.04);
    border: none; selection-background-color: #8B3A3A;
}
QTableWidget::item { padding: 2px 6px; }
QHeaderView::section {
    background: #1A1A1A; color: #86909C; border: none; border-bottom: 2px solid rgba(255,255,255,0.06);
    padding: 4px 8px; font-weight: bold; font-size: 11px;
}
QTabWidget::pane { border: none; background: #0D0D0D; }
QTabBar::tab {
    background: #1A1A1A; color: #86909C; border: none; padding: 6px 24px 6px 12px;
...
QScrollBar:horizontal { background: #0D0D0D; height: 6px; }
QScrollBar::handle:horizontal { background: #5A6270; border-radius: 3px; min-width: 30px; }
QScrollBar::add-line, QScrollBar::sub-line { height: 0; width: 0; }
QStatusBar { background: #0D0D0D; color: #86909C; border-top: 1px solid rgba(255,255,255,0.06); font-size: 11px; }
QListWidget { background: #1A1A1A; color: #A9B7C6; border: none; outline: none; }
...
QTreeWidget { background: #1A1A1A; color: #A9B7C6; border: none; outline: none; }
...
QMenu { background: #1A1A1A; color: #A9B7C6; border: 1px solid rgba(255,255,255,0.06); padding: 4px; }
